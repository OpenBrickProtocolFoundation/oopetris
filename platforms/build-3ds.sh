...
# cmake root path and settings
export CMAKE_FIND_ROOT_PATH_MODE_PROGRAM="BOTH"
...
export CMAKE_SYSTEM_INCLUDE_PATH="/include"
export CMAKE_SYSTEM_LIBRARY_PATH="/lib"
export CMAKE_SYSTEM_PROGRAM_PATH="/bin"
export CMAKE_ARGS="-DCMAKE_FIND_ROOT_PATH='$PORTLIBS_PATH_3DS;$LIBCTRU' -DCMAKE_FIND_ROOT_PATH_MODE_PACKAGE=ONLY"
