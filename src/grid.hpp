...
public:
    ...
    static constexpr Point hold_background_position{ 0, 0 };
    static constexpr Point grid_position = hold_background_position + Point{ preview_extends.x + 1, 0 };
    static constexpr Point preview_background_position{ grid_position.x + width_in_tiles + 1, 0 };
