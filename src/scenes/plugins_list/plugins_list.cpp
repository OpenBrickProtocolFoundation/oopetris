...
#include <plugins/discover.hpp>

#include "graphics/window.hpp"
#include "helper/constants.hpp"
#include "helper/graphic_utils.hpp"
#include "manager/resource_manager.hpp"
#include "plugins_component.hpp"
...
namespace scenes {
    ...
    using namespace details::plugins::list;


    PluginsList::PluginsList(ServiceProvider* service_provider, const ui::Layout& layout)
        ...
        m_main_layout.add<ui::Label>(
                service_provider, "Plugins List", service_provider->font_manager().get(FontId::Default),
    ...
    [[nodiscard]] Scene::UpdateResult PluginsList::update() {
    ...
    void PluginsList::render(const ServiceProvider& service_provider) {
    ...
    bool
    PluginsList::handle_event(const std::shared_ptr<input::InputManager>& input_manager, const SDL_Event& event) {
    ...
    void PluginsList::add_all_recordings() {
